...
paste0("<img src='{{site.baseurl}}/images/",x$next_meeting,"_category_plot.jpg' alt='The amount of time I spent across various categories' width='300'>\n"),
...
paste0("<img src='{{site.baseurl}}/images/",x$next_meeting,"_client_plot.jpg' alt='Who I worked with over the last two weeks' width='300'>\n"),
paste0("I worked on ", paste0(nrow(x$project))," projects. My time split amongst them was:\n"),
paste0("<img src='{{site.baseurl}}/images/",x$next_meeting,"_project_plot.jpg' alt='The different projects I worked on' width='300'>\n"),
...
paste0("<img src='{{site.baseurl}}/images/",x$next_meeting,"_weeks_since.jpg' alt='How long has it been since I visited different projects' width='300'>\n"),
fill = TRUE, sep = "")
  sink()
}
